...
import { 
  ...
  FileText, ClipboardList, Star, CheckCircle,
  Shield, Target, Gift, Coins, Trophy, Wallet,
  BadgeCheck, IndianRupee, Pause, Play, ChevronLeft, ChevronRight
} from 'lucide-react';
...
const ContributorsCarousel = ({ contributors }: { contributors: any[] }) => {
    ...
    <section className="py-16 lg:py-24 overflow-hidden">
      <div className="w-full px-8 lg:px-12">
        ...
        <div className="flex items-center justify-center gap-4 mb-8">
          <button
            onClick={scrollLeft}
            className="p-3 rounded-full bg-white dark:bg-dark-100 border border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 hover:border-blue-500 transition-all shadow-sm cursor-pointer"
          ...
          <button
            ...
            className={`p-3 rounded-full border transition-all shadow-sm cursor-pointer ${
              isPlaying 
      ...
      <section className="relative overflow-hidden py-20 lg:py-28 min-h-[520px] lg:min-h-[580px] flex items-center">
        <div className="absolute inset-0 z-0">
          ...
          <div
            ...
            style={{
              background: 'radial-gradient(ellipse 100% 80% at 50% 45%, rgba(0,0,0,0.5) 0%, rgba(0,0,0,0.25) 55%, rgba(0,0,0,0.45) 100%)',
            }}
          />
        ...
        <div className="w-full px-8 lg:px-12 relative z-10">
          <div className="relative rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-700 shadow-2xl group max-w-4xl mx-auto">
            ...
            <div className="absolute top-4 right-4 z-20 inline-flex items-center justify-center">
              <span className="btn-wave-ring absolute inset-0 rounded-lg border-2 border-purple-400/50" />
              ...
              return (
                ...
                >
                  <div className="relative aspect-[16/10] w-full overflow-hidden bg-gray-100 dark:bg-dark-200">
                    ...
                    <div className={`absolute bottom-4 left-4 flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br ${portal.gradient} shadow-lg ring-2 ring-white/30`}>
